...
namespace HoTroKhachHang.Api.Controllers
{
    ...
    public class NhanVienController : ControllerBase
    {
        ...
        public ObjectResult hienThiNhanVienVCS(List<EmployeeDTO> data)
        {
            dynamic foo = new ExpandoObject();
            ResponseOutput output = new ResponseOutput();
            try
        ...
        public async Task<IActionResult> danhSachNhanVien(int pagenumber,int pagesize)
        {
            ...
            result = PagedList<EmployeeDTO>.GetPagedList(result.AsQueryable(),pagenumber, pagesize);
            return hienThiNhanVienVCS(result);
        }
        [HttpGet("NVQuyen")]
